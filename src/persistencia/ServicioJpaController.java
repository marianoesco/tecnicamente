...
public class ServicioJpaController implements Serializable {
    ...
    public int getServicioCount() {
     ...
     public List<Servicio> FiltrarProductoPorNombre(String nombre) {
        List<Servicio> servicio = null;
        String jpql = "SELECT Object(u) FROM Servicio u WHERE u.nombre LIKE '%" + nombre + "%'";
        Query query = getEntityManager().createQuery(jpql);
        servicio = query.getResultList();
        return servicio;
    }
